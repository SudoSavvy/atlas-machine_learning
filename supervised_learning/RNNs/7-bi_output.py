#!/usr/bin/env python3
"""
Class that represents a bidirectional RNN cell with forward, backward, and output methods
"""
...
class BidirectionalCell:
    ...
    def output(self, H):
        ...
        Args:
            H (np.ndarray): concatenated hidden states from both directions, shape (t, m, 2 * h)
        ...
        for time_step in range(t):
            ...
            Y[time_step] = exp / np.sum(exp, axis=1, keepdims=True)
