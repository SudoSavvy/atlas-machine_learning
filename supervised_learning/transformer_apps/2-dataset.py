...
class Dataset():
    ...
    def __init__(self):
        """Loads the dataset splits, prepares tokenizers, and tokenizes the datasets.

        - Downloads and loads the 'ted_hrlr_translate/pt_to_en' dataset.
        - Separates the training and validation sets.
        - Creates tokenizers for Portuguese and English using the training data.
        - Applies TensorFlow tokenization wrapper to the training and validation datasets.
        ...
        # map datasets to encode tokens with tf wrapper
    ...
    def tf_encode(self, pt, en):
        ...
        Returns:
            pt_tokens (tf.Tensor): Tokenized Portuguese sentence with start and end tokens.
            en_tokens (tf.Tensor): Tokenized English sentence with start and end tokens.

        Notes:
            - Sets the shape of the returned tensors to (None,).
        """
