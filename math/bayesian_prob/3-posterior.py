#!/usr/bin/env python3
"""Module to calculate the posterior probability of hypothetical probabilities given data."""
...
def posterior(x, n, P, Pr):
    ...
    Returns:
    - numpy.ndarray: posterior probabilities for each value in P
    """
    # Input validation
    ...
    # Calculate posterior = intersection / marginal
