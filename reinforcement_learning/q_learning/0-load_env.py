...
def load_frozen_lake(desc=None, map_name=None, is_slippery=False):
    ...
    Args:
        desc (list[list[str]] | None): Custom map description. If None, uses map_name or random.
        map_name (str | None): Pre-made map name (e.g., "4x4", "8x8"). Ignored if desc is provided.
